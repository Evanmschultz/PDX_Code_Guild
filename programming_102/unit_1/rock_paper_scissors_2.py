...
print(float(1/3)) # binary conversion error.
...
while True:
    ...
    if user == computer: # mispelled variable #1
        print("Looks like a tie") # missing paranthesis #2
    ...
    # check all cases if user is rock
        ...
        # check losing case
        elif computer == "paper": # should be 'paper', would have missed this if I wasn't told there were 5 errors! lol #3
    ...
    # check all cases if user is paper
        ...
        # check winning case
        if computer == "rock": # missing colon #4
            print("You win!")
    ...
    # check all cases if user is scissors
        ...
        # check losing case
            ...
            print("Sorry, You lose.") # cap on print() #5
